...
class movieslider extends StatefulWidget {
  ...
  @override
  State<movieslider> createState() => _moviesState();
}

class _moviesState extends State<movieslider> {
  @override
  List movies =
  [
    "assets/goat.png",
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body : Column(
        children: [
          SizedBox(height: 10),
          Text("Top Movies for you",style: TextStyle(fontSize: 25,color: Colors.white,fontWeight: FontWeight.bold),),
          SizedBox(height: 20,),
